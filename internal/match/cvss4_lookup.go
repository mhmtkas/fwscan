...
// looked up here, then interpolated downwards by how far the vector sits from
// the most severe vector its MacroVector can hold. The 270 entries are data,
// not a derivation: they cannot be computed, only copied, so they are copied
// whole and checked against the reference implementation by the oracle test.
var cvss4MacroVectorScores = map[string]float64{
	"000000": 10,
	"000001": 9.9,
	"000010": 9.8,
	"000011": 9.5,
